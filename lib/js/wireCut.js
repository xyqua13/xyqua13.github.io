    ...
    app.controller("wireCutControl", function($scope) {
        ...
        $scope.removeItem = function (x) {
            window.dataLayer.push({"event":"trackEvent","category":"Basic Wires","action":"Remove Wire","label":$scope.basicWireColors[$scope.basicWires[x]]});
            if($scope.basicWires.length==0){
